...
function testeBooleano(resultadoImg1, resultadoImg2, resultadoImg3){
    var result1 = Number(resultadoImg1)
    var result2 = Number(resultadoImg2)
    var result3 = Number(resultadoImg3)
    

    if(result1 < result2 && resultadoImg1 < result3){
